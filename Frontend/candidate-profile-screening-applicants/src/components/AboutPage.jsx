      ...
      <main className="pt-20 pb-16">
        <div className="max-w-7xl mx-auto px-6 py-12">
            ...
            <div className="bg-white rounded-2xl p-8 shadow-xl border border-gray-100">
              <div className="grid grid-cols-2 gap-6">
                <div className="text-center">
                  <div className="w-16 h-16 bg-sg-red/10 rounded-full flex items-center justify-center mx-auto mb-3">
                    <Building className="w-8 h-8 text-sg-red" />
                  </div>
                  <div className="text-2xl font-bold text-sg-red">150+</div>
                  <div className="text-sm text-gray-600">Years of Excellence</div>
                </div>
                <div className="text-center">
                  <div className="w-16 h-16 bg-sg-red/10 rounded-full flex items-center justify-center mx-auto mb-3">
                    <Globe className="w-8 h-8 text-sg-red" />
                  </div>
                  <div className="text-2xl font-bold text-sg-red">60+</div>
                  <div className="text-sm text-gray-600">Countries</div>
                </div>
                <div className="text-center">
                  <div className="w-16 h-16 bg-sg-red/10 rounded-full flex items-center justify-center mx-auto mb-3">
                    <Users className="w-8 h-8 text-sg-red" />
                  </div>
                  <div className="text-2xl font-bold text-sg-red">117K+</div>
                  <div className="text-sm text-gray-600">Team Members</div>
                </div>
                <div className="text-center">
                  <div className="w-16 h-16 bg-sg-red/10 rounded-full flex items-center justify-center mx-auto mb-3">
                    <Target className="w-8 h-8 text-sg-red" />
                  </div>
                  <div className="text-2xl font-bold text-sg-red">200+</div>
          ...
          <div className="grid lg:grid-cols-2 gap-12 mb-20">
            <div className="bg-white rounded-2xl p-8 shadow-xl border border-gray-100">
              <div className="w-16 h-16 bg-sg-red/10 rounded-full flex items-center justify-center mb-6">
                <Target className="w-8 h-8 text-sg-red" />
              </div>
            ...
            <div className="bg-white rounded-2xl p-8 shadow-xl border border-gray-100">
              <div className="w-16 h-16 bg-sg-red/10 rounded-full flex items-center justify-center mb-6">
                <Zap className="w-8 h-8 text-sg-red" />
              </div>
          ...
          <div className="mb-20">
            ...
            <div className="grid lg:grid-cols-3 gap-8">
              <div className="text-center">
                <div className="w-20 h-20 bg-sg-red/10 rounded-full flex items-center justify-center mx-auto mb-4">
                  <Heart className="w-10 h-10 text-sg-red" />
                </div>
                <h3 className="text-xl font-bold text-gray-900 mb-3">Passion</h3>
                <p className="text-gray-600">We approach every challenge with enthusiasm and dedication, believing that passion drives innovation and excellence.</p>
              </div>
              <div className="text-center">
                <div className="w-20 h-20 bg-sg-red/10 rounded-full flex items-center justify-center mx-auto mb-4">
                  <Users className="w-10 h-10 text-sg-red" />
                </div>
                <h3 className="text-xl font-bold text-gray-900 mb-3">Collaboration</h3>
                <p className="text-gray-600">We believe the best solutions come from diverse perspectives working together towards a common goal.</p>
              </div>
              <div className="text-center">
                <div className="w-20 h-20 bg-sg-red/10 rounded-full flex items-center justify-center mx-auto mb-4">
                  <Award className="w-10 h-10 text-sg-red" />
                </div>
                <h3 className="text-xl font-bold text-gray-900 mb-3">Excellence</h3>
                <p className="text-gray-600">We strive for the highest quality in everything we do, continuously improving and pushing boundaries.</p>
              </div>
            </div>
          </div>
          ...
          <div className="bg-white rounded-2xl p-8 shadow-xl border border-gray-100">
            ...
            <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-6">
              <div className="text-center p-4">
                <div className="w-16 h-16 bg-sg-red/10 rounded-lg flex items-center justify-center mx-auto mb-3">
                  <Zap className="w-8 h-8 text-sg-red" />
                </div>
                <h3 className="font-semibold text-gray-900 mb-2">Cloud Computing</h3>
                <p className="text-sm text-gray-600">Scalable cloud solutions for modern businesses</p>
              </div>
              <div className="text-center p-4">
                <div className="w-16 h-16 bg-sg-red/10 rounded-lg flex items-center justify-center mx-auto mb-3">
                  <Globe className="w-8 h-8 text-sg-red" />
                ...
                <p className="text-sm text-gray-600">Intelligent automation and data insights</p>
              </div>
              <div className="text-center p-4">
                <div className="w-16 h-16 bg-sg-red/10 rounded-lg flex items-center justify-center mx-auto mb-3">
                  <Users className="w-8 h-8 text-sg-red" />
                ...
                <p className="text-sm text-gray-600">End-to-end digital modernization</p>
              </div>
              <div className="text-center p-4">
                <div className="w-16 h-16 bg-sg-red/10 rounded-lg flex items-center justify-center mx-auto mb-3">
                  <Building className="w-8 h-8 text-sg-red" />
                ...
                <p className="text-sm text-gray-600">Robust systems for large organizations</p>
              </div>
            </div>
          </div>
        </div>
